...
* tensorflow 2.3.0 (only for load MNIST and Fashion-MNIST dataset)
* pandas 1.2.3 (only for store experimental results)

If you want to run `src/experiments.py` with REUTERS dataset, you schould download it by `cd src/data; ./get_data.sh` and preprocess it by `src/data/make_reuters_dataset.py`.
